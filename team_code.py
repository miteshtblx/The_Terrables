...
def train_challenge_model(data_folder, model_folder, verbose):
    ...
    outcome_model = LGBMClassifier(boosting='gbdt', max_depth=10, num_iterations=1000, num_leaves=40).fit(features, outcomes.ravel())
    cpc_model = LGBMRegressor(boosting='gbdt', max_depth=10, num_iterations=1000, num_leaves=40).fit(features, cpcs.ravel())
